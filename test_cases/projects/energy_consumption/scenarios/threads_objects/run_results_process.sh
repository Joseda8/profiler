...
python3 -m test_cases.projects.energy_consumption.process_results.main --pattern "results/preprocessed/object_lists_nocopy_*_stats.csv" --output_file "$SUMMARY_DIR/threads_objects_object_lists_nocopy_summary.csv" --task_label object_lists_nocopy --variant_column num_workers

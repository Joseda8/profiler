...
# Mandelbrot sizes
for size in 1000 1500 2000 2500 3000 3500; do
...
for num_items in 7500 9000 12000 15000 20000 24000; do
...
# Prime sieve limits
for limit in 20000000 24000000 28000000 32000000 36000000 40000000; do

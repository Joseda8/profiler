...
def compute_checksum_for_row_slice(start_row_index: int, end_row_index: int, left_matrix: List[List[int]], right_matrix_transposed: List[List[int]]) -> int:
    """
...
if __name__ == "__main__":
    ...
    # Emit filename hint for the profiler
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_workers) as executor:
        future_checksums = [
            executor.submit(compute_checksum_for_row_slice, start_row_index, end_row_index, left_matrix, right_matrix_transposed)

"""
This benchmark performs a series of DataFrame operations using inplace methods.
...
# Rename a column
df_users.rename(columns={'location.street.number': 'street_number'}, inplace=True)
# Order by age
df_users.sort_values(by="dob.age", inplace=True)
# Reset index

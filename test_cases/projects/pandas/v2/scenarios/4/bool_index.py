...
by using a boolean indexing approach.

Benchmark Steps:
1. Load user data into a Pandas DataFrame with a specified number of records.
2. Generate boolean masks to identify "female" and "male" genders.
3. Substitute "female" with "F" and "male" with "M" in the `gender` column.
...
df_users.loc[df_users["gender"] == "female", "gender"] = "F"
df_users.loc[df_users["gender"] == "male", "gender"] = "M"

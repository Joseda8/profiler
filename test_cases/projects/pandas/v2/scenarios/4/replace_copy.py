"""
This benchmark substitutes the values in the `gender` column by using the replace method with 
the creation of a explicit copy.
...
df_users["gender"] = df_users["gender"].replace({"female": "F", "male": "M"})

"""
This benchmark evaluates the performance of an apply function over a DataFrame 
to replace the gender with a single letter in a Pandas DataFrame.
...
from .util_scenario import replace_gender_dataframe
...
# Replace the 'gender' column using apply
df_users["gender"] = df_users.apply(replace_gender_dataframe, axis=1)

"""
This benchmark drops duplicates considering three column.
...
# Drop duplicates inplace considering three columns
df_users.drop_duplicates(subset=["email", "login.uuid", "login.username"], inplace=True)

"""
This benchmark drops duplicates considering one column.
...
# Drop duplicates inplace considering one column
df_users.drop_duplicates(subset=["login.uuid"], inplace=True)
